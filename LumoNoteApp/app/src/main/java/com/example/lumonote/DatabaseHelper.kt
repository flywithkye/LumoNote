...
class DatabaseHelper (context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getAllNotes(): List<NoteItem> {
        val notesList = mutableListOf<NoteItem>() // Store note objects, similar to java arraylist
        val db = writableDatabase // Database manipulator object
        ...
        while (cursor.moveToNext()) {
            ...
            val note = NoteItem(id, title, content, createdDate, modifiedDate)
    ...
    fun getNoteByID(noteID: Int): NoteItem {
        ...
        */
        ...
        return NoteItem(id, title, content, created, modified)
    }
    ...
    fun getAllTags(): List<TagItem> {
        val tagsList = mutableListOf<TagItem>() // Store tag objects, similar to java arraylist
        val db = writableDatabase // Database manipulator object
    ...
    fun getTagByID(tagID: Int): TagItem {
        val db = readableDatabase // Database accessor object
